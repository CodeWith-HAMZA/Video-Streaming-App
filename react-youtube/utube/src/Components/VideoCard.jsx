...
const VideoCard = ({ item }) => {
  ...
  useEffect(() => {
    ...
    // console.log("Runnig VideoCARD USeefect")
    // (async () => {
    ...
    //   // console.log(
    //   //   "Chanel ID through props in viedoCards",
    //   //   item?.snippet?.channelId
    //   // );
    //   //  console.log("fetched-channel-image in viedoCards", data?.items[0]?.snippet?.thumbnails?.high?.url)
    // })();
  });
